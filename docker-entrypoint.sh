...
sed -i "s|K8S_METRICS_API_BASE_URL=https://kubernetes.default.svc|K8S_METRICS_API_BASE_URL=${K8S_METRICS_API_BASE_URL:-https://kubernetes.default.svc}|" ./build/.env
sed -i "s|K8S_NAMESPACE=jambonz|K8S_NAMESPACE=${K8S_NAMESPACE:-jambonz}|" ./build/.env
